...
document.addEventListener('DOMContentLoaded', () => {
  ...
  /* ========== CONFIG ========== */
  // ★ RELATIONSHIP START DATE — edit here ★
  const RELATIONSHIP_START = new Date('2026-01-04T00:00:00');

  const LOVE_MESSAGES = [
    'Happy Birthday 🎂', 'I love you 💜', 'You are my everything ❤️', 'Together forever 💕',
    'My heart is yours 💖', 'Adore you 🥰', 'You are wonderful ✨',
    'My beloved 🌸', 'Infinitely yours 💫', 'You are happiness 🦋', 'Love beyond words 🌹'
  ];

  const LYRICS = [
    { time: 30.0, text: "Watching the sunset on the coast," },
    { time: 33.9, text: "While we both grow old." },
    { time: 37.5, text: "I can't describe my feelings," },
    { time: 41.6, text: "All I know is we are coming home." },
    ...
    { time: 60.7, text: "As long as I'm next to you," },
    { time: 64.2, text: "A smile never leaves my face." },
    { time: 68.1, text: "Save your tears, everything will be fine," },
    { time: 72.1, text: "All I know is you are here with me." },
    { time: 79.9, text: "Watching the sunset as we grow old, oh-oh..." },
    { time: 87.7, text: "I can't describe, oh-oh..." },
    { time: 91.8, text: "I would like to live every memory of you" },
    { time: 95.5, text: "One more time before you fly away in the wind." },
    { time: 99.5, text: "And all the time we spent," },
    { time: 103.3, text: "Waiting for the moment when the light takes us," },
    { time: 107.2, text: "These were the best moments of my life." },
    { time: 111.0, text: "I don't care how much time it takes," },
    { time: 118.7, text: "As long as I'm next to you," },
    { time: 122.3, text: "A smile never leaves my face." },
    { time: 126.1, text: "Everything will be okay, just don't cry," },
